...
public static class ConstructionDefinitions
{
    ...
    public static readonly ConstructionDefinition WoodenChair = new ConstructionDefinition("Core.Furniture.Chair.Wood", "Wooden Chair", BuildingDefinitions.WoodenChair.Id, null, 120, ItemDefinitions.Wood);
