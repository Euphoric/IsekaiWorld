...
{
    public static BuildingDefinition RockWall { get; } = new("Core.Rock.Wall", "Rock Wall", Color.Color8(69, 67, 63), new Dictionary<HexagonDirection, string> { { HexagonDirection.Right, "res://Textures/Wall/wall texture.svg"}}, true, true);
    public static BuildingDefinition StoneWall { get; } = new("Core.Wall.Stone", "Stone Wall", Color.Color8(133, 133, 133), new Dictionary<HexagonDirection, string> { { HexagonDirection.Right,"res://Textures/Wall/wall texture.svg" }},true, true, new[]{DesignationDefinitions.Deconstruct}.ToImmutableHashSet());
    public static BuildingDefinition WoodenWall { get; } = new("Core.Wall.Wood", "Wooden Wall", Color.Color8(189, 116, 38), new Dictionary<HexagonDirection, string> { { HexagonDirection.Right, "res://Textures/Wall/wall texture.svg" }}, true, true, new[]{DesignationDefinitions.Deconstruct}.ToImmutableHashSet());

    public static BuildingDefinition StockpileZone { get; } = new("Core.Zone.Stockpile", "Stockpile", Color.Color8(3, 252, 252, 128), new Dictionary<HexagonDirection, string> { { HexagonDirection.Right, "res://Textures/Zone/stockpile.svg" }}, true, allowedDesignations: new[]{DesignationDefinitions.Deconstruct}.ToImmutableHashSet());
    
    public static BuildingDefinition WoodenChair { get; } = new("Core.Furniture.Chair.Wood", "Wooden Chair", Color.Color8(189, 116, 38), new Dictionary<HexagonDirection, string>
    {
    ...
    public static BuildingDefinition WoodenBed { get; } = new("Core.Furniture.Bed.Wood", "Wooden Bed", Color.Color8(189, 116, 38), new Dictionary<HexagonDirection, string>
    {
    ...
    public static BuildingDefinition TableStoveFueled { get; } = new("Core.Production.StoveFueled", "Fueled stove", Colors.White, new Dictionary<HexagonDirection, string>
    {
    ...
    public static BuildingDefinition CraftingDesk { get; } = new("Core.Production.CraftingDesk", "Crafting desk", Colors.SaddleBrown, new Dictionary<HexagonDirection, string>
    {
    ...
    public static BuildingDefinition TreeOak { get; } = new("Core.Tree.Oak", "Oak tree", Colors.White, new Dictionary<HexagonDirection, string> {
        { HexagonDirection.Left, "res://Textures/Plant/TreeOak.png" } }, allowedDesignations: new[]{DesignationDefinitions.CutWood}.ToImmutableHashSet());
